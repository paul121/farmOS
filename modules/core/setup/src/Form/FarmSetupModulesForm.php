...
/**
 * Form for selecting farmOS modules to install in the Setup Wizard.
 *
 * @ingroup farm
 */
class FarmSetupModulesForm extends FarmModulesForm {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'farm_setup_modules_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($modules as $module => $weight) {
      $operations[] = [
        [__NAMESPACE__ . '\FarmSetupModulesForm', 'farmInstallModuleBatch'],
