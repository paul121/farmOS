...
class AssetAddLogActionForm extends ConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->formatPlural(count($this->entities), 'Are you sure you want to add logs referencing this @item?', 'Are you sure you want to add logs referencing these @items?', [
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $log_types = $this->entityTypeManager->getStorage('log_type')->loadMultiple();
