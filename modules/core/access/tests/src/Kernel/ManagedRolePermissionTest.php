...
namespace Drupal\Tests\farm_access\Kernel;
 ...
 * @group farm
 */
class ManagedRolePermissionTest extends KernelTestBase {
  ...
  protected function setUp() {
    ...
    $this->installConfig(['farm_access', 'farm_access_test', 'log']);
  }
  ...
  public function testManagedRoleConfigAccess() {
    ...
    $this->assertNotEmpty($role->getThirdPartySetting('farm_access', 'access', FALSE));
