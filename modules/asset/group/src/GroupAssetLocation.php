...
class GroupAssetLocation extends AssetLocation implements AssetLocationInterface {
  ...
  public function getAssetsByLocation(array $locations): array {
    ...
    // Recursively load all group members.
    ...
    // locations match.
    $members = array_filter($members, function (AssetInterface $asset) use ($location_ids) {
    ...
    // Include filtered group members in the list of assets.
